...
DEFAULT_PATTERNS = ("G" + "PT/", "C" + "LAUDE/", "policy-" + "g" + "pt", "policy-" + "cla" + "ude")
DEFAULT_ROOTS = ("engine", "apps", "packages", "tests", "tools", "docs/current")
DEFAULT_IGNORE_FILES = ("tools/path_reference_audit.py",)
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Audit path references in active code/docs.")
