...
def run(
    ...
    if policy_mode == "arena":
        if not player_character_policy_modes:
            player_character_policy_modes = {1: "heuristic_v2_aggressive", 2: "heuristic_v2_v3_claude", 3: "heuristic_v2_control", 4: "heuristic_v2_balanced"}
...
if __name__ == "__main__":
    ...
    ap.add_argument("--lap-policy-mode", choices=sorted(HeuristicPolicy.VALID_LAP_POLICIES), default="heuristic_v1")
