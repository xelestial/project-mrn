...
class RuleFixTests(unittest.TestCase):
    ...
    def test_eosa_blocks_only_muroe_skills_including_tamgwan_and_swindler(self):
        ...
        target.current_character = "아전"  # 관원 -> 탐관오리 패시브 대상
        target.shards = 4
        target.cash = 20
    ...
    def test_cleanup_deck_profile_tracks_fire_and_wildfire_remaining(self):
        ...
        self.assertEqual(profile2["remaining_cleanup_cards"], 0.0)
        self.assertEqual(profile2["next_draw_cleanup_prob"], 0.0)
    ...
    def test_end_turn_cleanup_pressure_keeps_probabilistic_cleanup_risk(self):
        ...
        self.assertGreaterEqual(pressure["expected_cleanup_cost"], pressure["immediate_cleanup_cost"])
