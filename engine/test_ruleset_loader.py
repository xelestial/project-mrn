    ...
    def test_rules_roundtrip_dict(self):
        raw = {
            'rules': {
                ...
                'end': {'f_threshold': 9, 'tiles_to_trigger_end': 7, 'monopolies_to_trigger_end': 2, 'alive_players_at_most': 3, 'max_rounds': 4, 'max_turns': 10},
            }
        }
        ...
        self.assertEqual(dumped['rules']['end']['max_rounds'], 4)
        self.assertEqual(dumped['rules']['end']['max_turns'], 10)
