...
from runtime_modules.modifiers import BUILDER_FREE_PURCHASE_KIND, ModifierRegistry, seed_builder_purchase_modifier
...
def test_purchase_context_builder_free_purchase_does_not_consume_one_shot_flag() -> None:
    ...
    player.trick_free_purchase_this_turn = True
    seed_builder_purchase_modifier(state, player_id=player.player_id, source_module_id="CharacterStartModule:test")
