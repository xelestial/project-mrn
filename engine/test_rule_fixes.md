...
- 2026-05-03 nested-module sync: rule regressions remain here, while child-sequence safety coverage for trick choice/resolve loops, fortune extra roll-and-arrive modules, and runtime modifier attachment lives in `test_runtime_sequence_modules.py`.
