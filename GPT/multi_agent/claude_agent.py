...
class ClaudePlayerAgent(AbstractPlayerAgent):
    """Wrap the CLAUDE heuristic policy as an AbstractPlayerAgent."""

    def __init__(self, profile: str = "heuristic_v2_v3_claude"):
        with _CLAUDE_RUNTIME.activated():
    ...
    def choose_geo_bonus(self, state, player, actor_name):
        return self._call(self._policy.choose_geo_bonus, state, player, actor_name)
