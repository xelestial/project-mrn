...
- Rent landing can defer payment to `resolve_rent_payment` and adjacent-buy/same-tile handling to `resolve_landing_post_effects` when the queued action pipeline is active; direct landing calls still resolve inline.
