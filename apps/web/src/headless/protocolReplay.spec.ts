    ...
    const events: HeadlessTraceEvent[] = [
      {
        ...
        payload: {
          runtime_status: "waiting_input",
          player_summaries: [
            { player_id: 1, cash: 20, score: 2, total_score: 2, shards: 1, owned_tile_count: 1, alive: true },
      ...
      },
      {
        ...
        payload: {
          runtime_status: "completed",
          player_summaries: [
            { player_id: 1, cash: 25, score: 3, total_score: 3, shards: 2, owned_tile_count: 1, alive: true },
            { player_id: 2, cash: 18, score: 3, total_score: 3, shards: 1, owned_tile_count: 2, alive: true },
          ],
        },
      },
