export const enLocale = {
  ...
  promptHelper: {
    ...
    byType: {
      ...
      start_reward: "Choose a starting cash/shard/point bundle within the 20-point budget.",
  ...
  eventLabel: {
    events: {
      ...
      action_move: "Piece move",
      fortune_move: "Fortune move",
      forced_move: "Forced move",
      chain_move: "Chain move",
      ...
      start_reward_chosen: "Starting reward",
      ...
      turn_end_snapshot: "Turn end state",
    },
    nonEvents: {
      prompt: "Prompt",
  ...
  theater: {
    ...
    payoffBeat: {
      ...
      start_reward_chosen: "Starting reward resolved",
