...
def run_batch(simulations: int = 1000, seed: int = 42, config: GameConfig | None = None, policy_mode: str = "heuristic_v1"):
    rng = random.Random(seed)
    policy = HeuristicPolicy(character_policy_mode=policy_mode, lap_policy_mode="heuristic_v1")
...
def run_single_logged(seed: int = 42, config: GameConfig | None = None, policy_mode: str = "heuristic_v1"):
    policy = HeuristicPolicy(character_policy_mode=policy_mode, lap_policy_mode="heuristic_v1")
    runtime_config = config if config is not None else DEFAULT_CONFIG
...
def main(simulations: int = 1000, seed: int = 42, output_path: str | None = None, policy_mode: str = "heuristic_v1"):
...
if __name__ == "__main__":
    main(simulations=1000, seed=42, policy_mode="heuristic_v1")
