...
기준 소스:
- [GPT/trick.csv](/Users/sil/Workspace/project-mrn/GPT/trick.csv)
- [GPT/trick_cards.py](/Users/sil/Workspace/project-mrn/GPT/trick_cards.py)
- [GPT/state.py](/Users/sil/Workspace/project-mrn/GPT/state.py)
- [GPT/engine.py](/Users/sil/Workspace/project-mrn/GPT/engine.py)
- [GPT/effect_handlers.py](/Users/sil/Workspace/project-mrn/GPT/effect_handlers.py)

## 1. 기본 구조

현재 구조는 다음 순서로 동작한다.

1. [GPT/trick.csv](/Users/sil/Workspace/project-mrn/GPT/trick.csv)에서 카드 이름, 설명, 매수 정보를 읽는다.
2. [GPT/trick_cards.py](/Users/sil/Workspace/project-mrn/GPT/trick_cards.py)가 이를 `TrickCard` 객체로 만든다.
3. [GPT/state.py](/Users/sil/Workspace/project-mrn/GPT/state.py)의 `PlayerState.trick_hand`가 실제 손패를 가진다.
4. [GPT/engine.py](/Users/sil/Workspace/project-mrn/GPT/engine.py)가
   - 잔꾀 공개/비공개 처리
   - 자신의 턴 잔꾀 단계
   - 재굴림 예산(뭘리권/뭔칙휜) 처리
   - 강제 매각/도착 트리거
   - 보급 시 burden 교환
   를 관리한다.
5. [GPT/effect_handlers.py](/Users/sil/Workspace/project-mrn/GPT/effect_handlers.py)의 `handle_trick_card(...)`가 각 카드의 직접 효과를 처리한다.
...
관련 구현:
- [GPT/state.py](/Users/sil/Workspace/project-mrn/GPT/state.py)의 `public_trick_cards()`
- [GPT/state.py](/Users/sil/Workspace/project-mrn/GPT/state.py)의 `hidden_trick_count()`
- [GPT/engine.py](/Users/sil/Workspace/project-mrn/GPT/engine.py)의 `_sync_trick_visibility(...)`
...
관련 구현:
- [GPT/trick_cards.py](/Users/sil/Workspace/project-mrn/GPT/trick_cards.py)
- [GPT/engine.py](/Users/sil/Workspace/project-mrn/GPT/engine.py)의 `_use_trick_phase(...)`, `_try_anytime_rerolls(...)`

주의:
- 아래 카드별 상세에서 `is_anytime` 표기가 남아 있더라도, 최신 규칙 기준 해석은 모두 `아니오`다.

관련 구현:
- [GPT/engine.py](/Users/sil/Workspace/project-mrn/GPT/engine.py)의 `_use_trick_phase(...)`
