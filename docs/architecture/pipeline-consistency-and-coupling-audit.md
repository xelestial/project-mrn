# Pipeline Consistency and Coupling Audit

Canonical document path. Mirror in `PLAN/[REVIEW]_PIPELINE_CONSISTENCY_AND_COUPLING_AUDIT.md` is kept only for legacy links.
