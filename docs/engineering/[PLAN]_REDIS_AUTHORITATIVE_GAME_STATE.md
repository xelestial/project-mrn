...
- Decision-bearing fortune effects should produce actions instead of opening prompts during fortune draw resolution. The first migrated card is subscription-style empty-block purchase, which now produces `resolve_fortune_subscription`.
