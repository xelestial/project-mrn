...
5. Task-specific spec:
   ...
   - substrate maintenance loop (executed by GPT): `docs/architecture/claude-substrate-maintenance-loop.md`
...
| substrate contract loop (executed by GPT) | `docs/architecture/claude-substrate-maintenance-loop.md` | shared runtime contract + status index |
