## CHANGELOG.md에 추가할 항목

```markdown
## v0.7.61-arch-spec (2026-03-27)
- Added `ARCHITECTURE_REFACTOR_AGREED_SPEC_v1_0.md`: Claude / GPT 공동 합의 아키텍처 리팩토링 명세.
  Phase 1~4 단계별 분리 계획, ProfileSpec / SurvivalStrategy / TurnContextBuilder /
